...
const MILESTONES: MilestoneItem[] = [
  ...
  {
    yearDisplay: "2017",
    title: "Colombo Hub & Fleet Expansion",
    desc: "Opened South Asia hub in Colombo; group fleet under management expanded significantly across Asian trade corridors.",
    icon: Anchor,
  },
  {
    yearDisplay: "2022",
  ...
  {
    yearDisplay: "2025",
    title: "Turkey Office Established",
    desc: "Expanded Mediterranean footprint with Istanbul branch office in Çekmeköy, connecting Black Sea and European trade routes.",
    icon: Globe,
  },
  {
    yearDisplay: "Present",
    title: "Present Day — Global Fleet Command",
    desc: "Leading a five-hub, 59-vessel ship management group across India, UAE, Sri Lanka, Canada, and Turkey.",
    icon: Compass,
    highlight: true,
  },
];
