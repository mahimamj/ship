  ...
  return (
    <section className="py-20 md:py-36 bg-[#FFFFFF] text-[#071A2B] border-b border-[rgba(7,26,43,0.12)]">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 space-y-16 sm:space-y-28">
        <div className="border-b border-[rgba(7,26,43,0.12)] pb-8" data-scroll-reveal="fade-up">
          <span className="label-mono text-[#176B87] mb-2.5 block font-semibold">
            // OPERATIONAL PRINCIPLES
          </span>
          <h2 className="font-jakarta text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-[#071A2B]" data-scroll-split>
            WHY OCEANIC STAR
          </h2>
        </div>

        <div className="space-y-16 sm:space-y-24" data-scroll-stagger>
          {statements.map((st, idx) => (
            ...
            >
              <div className="font-jakarta font-extrabold text-[clamp(2.2rem,8vw,5.5rem)] tracking-tight text-[#071A2B] leading-none break-words" data-scroll-reveal="clip-up" data-scroll-delay={`${idx * 0.1}`}>
                {st.keyword}
              </div>
