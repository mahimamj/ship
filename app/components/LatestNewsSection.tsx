...
export const REAL_LINKEDIN_POSTS: LinkedInPost[] = [
  ...
  },
  {
    ...
    linkedinUrl: LINKEDIN_COMPANY_URL,
    timeAgo: "2mo",
    badge: "RPSL-MUM-506 COMPLIANCE",
    title: "STCW Seafarer Officer Induction & Maritime Safety Standards",
    caption: "Welcoming our latest batch of deck and engine seafarer officers at our Navi Mumbai crewing hub. Operating strictly under IMO, ISM Code, STCW 2010, and MLC 2006 compliance for zero operational downtime.",
  },
  {
    id: "post-5",
    ...
    linkedinUrl: LINKEDIN_COMPANY_URL,
    timeAgo: "4mo",
    badge: "GLOBAL FLEET DISPATCH",
    title: "24/7 Crewing & Technical Superintendency Operations",
    caption: "Our Navi Mumbai crewing center and technical management desks in Dubai and Istanbul delivering round-the-clock support for 59+ managed commercial fleet vessels across Arabian Gulf & Asian corridors.",
  },
];
