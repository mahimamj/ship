...
export const GlobalPresenceMap: React.FC = () => {
  ...
  const hubs: Record<HubKey, HubInfo> = {
    dubai: {
      ...
      address: "Office No. 601, 6th Floor, Al Jawharah Building, Bur Dubai, UAE",
      phone: "+971 43889981",
      email: "info@oceanicstarfleet.com",
      licenseBadge: "UAE Commercial License Approved",
    },
    mumbai: {
      id: "mumbai",
      ...
      address: "Real Tech Park, Office No. 602–603, Sector 30A, Vashi, Navi Mumbai – 400 703, India",
      phone: "+91 22 27817171/72",
      email: "info@oceanicstarshipping.com",
      licenseBadge: "DG Shipping RPSL-MUM-506 Approved",
    },
    colombo: {
      id: "colombo",
      ...
      phone: "+971 5615-81941",
      email: "operations@oceanicstarfleet.com",
