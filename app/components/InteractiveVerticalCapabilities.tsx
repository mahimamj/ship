    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-[rgba(7,26,43,0.12)] pb-10 mb-16 gap-8">
          ...
          <p className="text-sm font-manrope text-[#667783] max-w-md leading-relaxed" data-scroll-reveal="fade-left" data-scroll-delay="0.2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-0 border-t border-[rgba(7,26,43,0.12)]" data-scroll-stagger>
