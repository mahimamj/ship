...
export const FloatingWhatsAppButton: React.FC = () => {
  return (
    <a
      ...
      className="fixed bottom-20 right-4 sm:right-6 z-40 w-12 h-12 sm:w-13 sm:h-13 rounded-full bg-[#25D366] hover:bg-[#20ba5a] text-white shadow-2xl flex items-center justify-center border border-white/30 hover:scale-110 active:scale-95 transition-all group"
